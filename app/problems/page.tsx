    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <section className="border-y border-zinc-800 py-12">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-3 gap-8 text-center">
          <div>
            <div style={{fontFamily:'Georgia,serif'}} className="text-4xl font-bold text-white mb-2">8+</div>
          ...
          <div>
            ...
            <div className="text-zinc-400 text-[14px]">Topic categories</div>
          </div>
          <div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            { icon: '📊', title: 'Real interview questions', desc: 'Practice questions directly from investment banking and PE interviews — 3-statement, DCF, LBO, valuation, and more.' },
            ...
            { icon: '💡', title: 'Coaching feedback', desc: 'Miss a concept? Get targeted, bullet-point feedback that tells you exactly what to add and how to say it in an interview.' },
            { icon: '🧩', title: 'Answer frameworks', desc: 'Every question comes with a step-by-step structure guide showing exactly how interviewers expect you to answer.' },
            { icon: '📈', title: 'Track progress', desc: 'See which questions you\'ve solved and monitor your improvement across categories and difficulty levels.' },
